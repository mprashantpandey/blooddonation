@php
    $inp = $inp ?? 'w-full rounded-xl border border-zinc-200/80 bg-white/80 px-3 py-2.5 text-sm text-zinc-900 shadow-inner focus:border-red-500/80 focus:outline-none focus:ring-2 focus:ring-red-500/20';
